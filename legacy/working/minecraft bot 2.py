...
class MinecraftBot:
    ...
    def load_config(self, config_file):
        ...
        try:
            ...
            print("⚠️  Please edit minecraft_bot_config.json with your server details before running!")
            sys.exit(1)
    
    def save_config(self, config_file="minecraft_bot_config.json"):
        ...
        try:
            ...
            if cmd == "come":
                ...
                help_text = [
                    ...
                    f"{prefix}pos - Show my position",
                    f"{prefix}help - Show this help"
                ]
                # Send help in multiple messages to avoid chat limits
                for line in help_text:
                    self.bot.chat(line)
                    time.sleep(0.1)  # Small delay to avoid being kicked for spam
        ...
        try:
            ...
            if cmd == "say" and args:
                ...
                if args and args[0].lower() == "forward":
                    # For lodestone, we need to use the bot's control state methods
                ...
                if args and args[0] == "reload":
                    self.load_config("minecraft_bot_config.json")
...
🎮 In-Game Chat Commands (prefix: {}):
  !come, !stop, !jump, !list, !say <message>, !pos, !help
    ...
    def start_bot(self):
        ...
        try:
            # Create the bot instance without the chat parameter
            self.bot = lodestone.createBot(
                ...
                # Removed: chat=self.handle_chat - we'll set up events separately
            )
